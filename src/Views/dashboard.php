...
// It is a plain numeric serial number, e.g. 100000482917
$credentialFields = [
    'AcademicCredential' => [
            ...
            <div class="rounded-lg border border-emerald-800/60 bg-emerald-900/10 px-4 py-3 flex items-start gap-3">
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-[10px] text-slate-500">
                        ...
                        (e.g. <code class="text-emerald-400">100000482917</code>) when this credential is issued.
    ...
    <div class="rounded-xl border border-slate-800 bg-slate-900 p-6 space-y-4">
        <div>
            ...
            <p class="text-xs text-slate-500 mt-1">
                ...
                printed on the holder's certificate (a 12-digit number).
            </p>
        </div>
