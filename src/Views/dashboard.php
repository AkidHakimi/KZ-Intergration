...
// Standardised Malaysian-style serial format: KZ-<YEAR>-<8 hex chars>
$credentialFields = [
    'AcademicCredential' => [
            ...
            <div class="rounded-lg border border-emerald-800/60 bg-emerald-900/10 px-4 py-3 flex items-start gap-3">
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-[10px] text-slate-500">
                        The system automatically assigns a standardised Malaysian-format serial
                        (<code class="text-emerald-400">KZ-YYYY-XXXXXXXX</code>) when this credential is issued.
    ...
    <div class="rounded-xl border border-slate-800 bg-slate-900 p-6 space-y-4">
        <div>
            ...
            <p class="text-xs text-slate-500 mt-1">
                ...
                printed on the holder's certificate (format <code class="text-emerald-400">KZ-YYYY-XXXXXXXX</code>).
            </p>
        </div>
        <form action="<?= $base ?>/credentials/verify" method="POST" class="space-y-4">
            ...
            <div class="space-y-1.5">
                ...
                <input name="certificate_serial" type="text" required
                       placeholder="KZ-2024-1A2B3C4D"
                       autocomplete="off"
                       class="w-full rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5
                              text-sm font-mono text-slate-100 uppercase tracking-wider
