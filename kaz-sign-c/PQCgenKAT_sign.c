...
int main(void)
{
    ...
    do {
        ...
        sm = (unsigned char *)calloc(KAZ_DS_S1BYTES+KAZ_DS_S2BYTES+KAZ_DS_S3BYTES+mlen, sizeof(unsigned char));
    ...
    printf("Approx milliseconds, keygen: %.0f\n",
        (double)((double)tkeygentotal / CLOCKS_PER_SEC) * 1000);
    printf("Approx milliseconds, signing: %.0f\n",
        (double)((double)tsigntotal / CLOCKS_PER_SEC) * 1000);
    printf("Approx milliseconds, verifying: %.0f\n",
